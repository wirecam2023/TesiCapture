#ifndef _MSTCOMPLICANZE3MODDLG_H_
	#define _MSTCOMPLICANZE3MODDLG_H_

class CMstComplicanze3ModDlg : public CDialog
{
	DECLARE_DYNAMIC(CMstComplicanze3ModDlg)

public:

	CMstComplicanze3ModDlg(CWnd* pParent, CEsamiView* pEsamiView);
	virtual ~CMstComplicanze3ModDlg();

	enum { IDD = IDD_MST_COMPLICANZE3_MOD };
...
#endif /* _MSTCOMPLICANZE3MODDLG_H_ */