#ifndef _MSTCOMPLICANZE2USEDLG_H_
	#define _MSTCOMPLICANZE2USEDLG_H_

#include "SediTreeCtrl.h"

class CMstComplicanze2UseDlg : public CDialog
{
	DECLARE_DYNAMIC(CMstComplicanze2UseDlg)

public:

	CMstComplicanze2UseDlg(CWnd* pParent, CEsamiView* pEsamiView);
	virtual ~CMstComplicanze2UseDlg();
...
#endif /* _MSTCOMPLICANZE2USEDLG_H_ */