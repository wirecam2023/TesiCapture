...
IMPLEMENT_DYNAMIC(CMstComplicanze2ModDlg, CDialog)

CMstComplicanze2ModDlg::CMstComplicanze2ModDlg(CWnd* pParent, CEsamiView* pEsamiView)
	: CDialog(CMstComplicanze2ModDlg::IDD, pParent)
{
...
CMstComplicanze2ModDlg::~CMstComplicanze2ModDlg()
{
}

BEGIN_MESSAGE_MAP(CMstComplicanze2ModDlg, CDialog)
	ON_WM_CTLCOLOR()
...
void CMstComplicanze2ModDlg::DoDataExchange(CDataExchange* pDX)
{
...
HBRUSH CMstComplicanze2ModDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
BOOL CMstComplicanze2ModDlg::OnInitDialog()
{
	...
	theApp.LocalizeDialog(this, CMstComplicanze2ModDlg::IDD, "MstComplicanze2ModDlg");
	return bReturn;
}

void CMstComplicanze2ModDlg::OnLbnSelchangeListLevel0()
{
...
void CMstComplicanze2ModDlg::OnLbnSelchangeListLevel1()
{
...
void CMstComplicanze2ModDlg::OnLbnSelchangeListLevel2()
{
...
void CMstComplicanze2ModDlg::OnLbnSelchangeListLevel3()
{
...
void CMstComplicanze2ModDlg::OnLbnSelchangeListLevel4()
{
...
void CMstComplicanze2ModDlg::OnLbnSelchangeListLevel5()
{
...
void CMstComplicanze2ModDlg::OnLbnSelchangeListLevel6()
{
...
void CMstComplicanze2ModDlg::OnBnClickedBtnNew0()
{
	NewString(0, 0);
}

void CMstComplicanze2ModDlg::OnBnClickedBtnEdt0()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnDel0()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnNew1()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnEdt1()
{
	int iTemp = m_ctrlListLevel1.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnDel1()
{
	int iTemp = m_ctrlListLevel1.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnNew2()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnEdt2()
{
	int iTemp = m_ctrlListLevel2.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnDel2()
{
	int iTemp = m_ctrlListLevel2.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnNew3()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnEdt3()
{
	int iTemp = m_ctrlListLevel3.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnDel3()
{
	int iTemp = m_ctrlListLevel3.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnNew4()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnEdt4()
{
	int iTemp = m_ctrlListLevel4.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnDel4()
{
	int iTemp = m_ctrlListLevel4.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnNew5()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnEdt5()
{
	int iTemp = m_ctrlListLevel5.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnDel5()
{
	int iTemp = m_ctrlListLevel5.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnNew6()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnEdt6()
{
	int iTemp = m_ctrlListLevel6.GetCurSel();
...
void CMstComplicanze2ModDlg::OnBnClickedBtnDel6()
{
	int iTemp = m_ctrlListLevel6.GetCurSel();
...
void CMstComplicanze2ModDlg::RiempiListLevel0()
{
	int iTemp = 0;
	...
	if (setTemp.OpenRecordset("CMstComplicanze2ModDlg::RiempiListLevel0") == TRUE)
	{
		...
		setTemp.CloseRecordset("CMstComplicanze2ModDlg::RiempiListLevel0");
	}
}

void CMstComplicanze2ModDlg::RiempiListSubLevels(long lPadre)
{
	...
	for(nTemp = 0; nTemp < 6; nTemp++)
	{
		...
		if (setTemp.OpenRecordset("CMstComplicanze2ModDlg::RiempiListSubLevels") == TRUE)
		{
			while(setTemp.IsEOF() == FALSE)
			{
	...
	setTemp.CloseRecordset("CMstComplicanze2ModDlg::RiempiListSubLevels");
}

void CMstComplicanze2ModDlg::NewString(long lPadre, long lLivello)
{
	...
	if (dlg.DoModal() == IDOK)
	{
		...
		if (setTemp.OpenRecordset("CMstComplicanze2ModDlg::NewString") == TRUE)
		{
			if (setTemp.AddNewRecordset("CMstComplicanze2ModDlg::NewString") == TRUE)
			{
				setTemp.m_lPadre = lPadre;
				setTemp.m_lLivello = lLivello;
				setTemp.m_sDescrizione = dlg.GetValue();

				setTemp.UpdateRecordset("CMstComplicanze2ModDlg::NewString");
			}

			setTemp.CloseRecordset("CMstComplicanze2ModDlg::NewString");
		}
...
void CMstComplicanze2ModDlg::EdtString(long lID)
{
	CString strTemp;
	long lLivello = 0;
	BOOL bEdited = FALSE;
	...
	if (setTemp.OpenRecordset("CMstComplicanze2ModDlg::EdtString") == TRUE)
	{
		if (setTemp.IsEOF() == FALSE)
		{
			...
			if (dlg.DoModal() == IDOK)
			{
				...
				if (setTemp.EditRecordset("CMstComplicanze2ModDlg::EdtString") == TRUE)
				{
					bEdited = TRUE;

					setTemp.m_sDescrizione = dlg.GetValue();

					setTemp.UpdateRecordset("CMstComplicanze2ModDlg::EdtString");
				}
			}
		}

		setTemp.CloseRecordset("CMstComplicanze2ModDlg::EdtString");
	}
...
void CMstComplicanze2ModDlg::DelString(long lID)
{
	CString strTemp;
	long lLivello = 0;
	BOOL bDeleted = FALSE;
	...
	if (setTemp.OpenRecordset("CMstComplicanze2ModDlg::EdtString") == TRUE)
	{
		...
		if (bDeleted == TRUE)
			setTemp.DeleteRecordset("CMstComplicanze2ModDlg::EdtString");
