...
IMPLEMENT_DYNAMIC(CMstProcedureDiagnosticheUseDlg, CDialog)

CMstProcedureDiagnosticheUseDlg::CMstProcedureDiagnosticheUseDlg(CWnd* pParent, CEsamiView* pEsamiView)
	: CDialog(CMstProcedureDiagnosticheUseDlg::IDD, pParent)
{
...
CMstProcedureDiagnosticheUseDlg::~CMstProcedureDiagnosticheUseDlg()
{
}

BEGIN_MESSAGE_MAP(CMstProcedureDiagnosticheUseDlg, CDialog)
	ON_WM_CTLCOLOR()
...
void CMstProcedureDiagnosticheUseDlg::DoDataExchange(CDataExchange* pDX)
{
...
HBRUSH CMstProcedureDiagnosticheUseDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
BOOL CMstProcedureDiagnosticheUseDlg::OnInitDialog()
{
	...
	theApp.LocalizeDialog(this, CMstProcedureDiagnosticheUseDlg::IDD, "MstProcedureDiagnosticheUseDlg");
...
CString CMstProcedureDiagnosticheUseDlg::GetValue()
{
	return m_strValue;
}

void CMstProcedureDiagnosticheUseDlg::SetValue(CString sValue)
{
	m_strValue = sValue;
}

void CMstProcedureDiagnosticheUseDlg::OnBnClickedOk()
{
...
void CMstProcedureDiagnosticheUseDlg::CreaFrase()
{
	int iTemp;
	CString strTemp;
	CString strValue = "";
...
void CMstProcedureDiagnosticheUseDlg::RiempiListOrgani()
{
	int iTemp;
	...
	if (lTipoEsame == 0 || m_pEsamiView->m_pEsamiSet->IsFieldNull(&m_pEsamiView->m_pEsamiSet->m_lIDEsame))
	{
		...
		if (setTemp.OpenRecordset("CMstProcedureDiagnosticheUseDlg::RiempiListOrgani") == TRUE)
		{
			while (!setTemp.IsEOF())
			{
			...
			setTemp.CloseRecordset("CMstProcedureDiagnosticheUseDlg::RiempiListOrgani");
		}
	}
	else
	{
		...
		if (setJoin.OpenRecordset("CMstProcedureDiagnosticheUseDlg::RiempiListOrgani") == TRUE)
		{
			while(setJoin.IsEOF() == FALSE)
			{
				...
				if (setOrgano.OpenRecordset("CMstProcedureDiagnosticheUseDlg::RiempiListOrgani") == TRUE)
				{
			...
			setOrgano.CloseRecordset("CMstProcedureDiagnosticheUseDlg::RiempiListOrgani");
			setJoin.CloseRecordset("CMstProcedureDiagnosticheUseDlg::RiempiListOrgani");
		}
	}
}

void CMstProcedureDiagnosticheUseDlg::RiempiTreeSedi()
{
	HTREEITEM hPadre;
	...
	if (setTemp1.OpenRecordset("CMstProcedureDiagnosticheUseDlg::RiempiTreeSedi") == FALSE)
		return;
	...
	while(setTemp1.IsEOF() == FALSE)
	{
		...
		if (setTemp2.OpenRecordset("CMstProcedureDiagnosticheUseDlg::RiempiTreeSedi") == TRUE)
		{
			...
			setTemp2.CloseRecordset("CMstProcedureDiagnosticheUseDlg::RiempiTreeSedi");
		}
	...
	setTemp1.CloseRecordset("CMstProcedureDiagnosticheUseDlg::RiempiTreeSedi");
}

void CMstProcedureDiagnosticheUseDlg::RiempiListLevel0()
{
	int iTemp = 0;
...
void CMstProcedureDiagnosticheUseDlg::RiempiListSubLevels()
{
...
void CMstProcedureDiagnosticheUseDlg::OnBnClickedDeselect()
{
...
void CMstProcedureDiagnosticheUseDlg::OnLbnSelchangeListOrgani()
{
	RiempiTreeSedi();
...
void CMstProcedureDiagnosticheUseDlg::OnTvnSelchangedTreeSedi(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CMstProcedureDiagnosticheUseDlg::OnLbnSelchangeListLevel0()
{
	RiempiListSubLevels();
...
void CMstProcedureDiagnosticheUseDlg::OnLbnSelchangeListLevel1()
{
	CreaFrase();
}

void CMstProcedureDiagnosticheUseDlg::OnLbnSelchangeListLevel2()
{
	CreaFrase();
}

void CMstProcedureDiagnosticheUseDlg::OnLbnSelchangeListLevel3()
{
	CreaFrase();
}

void CMstProcedureDiagnosticheUseDlg::OnLbnSelchangeListLevel4()
{
	CreaFrase();
}

void CMstProcedureDiagnosticheUseDlg::OnLbnSelchangeListLevel5()
{
	CreaFrase();
}

void CMstProcedureDiagnosticheUseDlg::OnLbnSelchangeListLevel6()
{
	CreaFrase();
}

void CMstProcedureDiagnosticheUseDlg::OnBnClickedAggiungi()
{
	CString strFrase;
