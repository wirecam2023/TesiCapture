#ifndef _SORGENTISTREAMINGCONFIGDLG_H_
	#define _SORGENTISTREAMINGCONFIGDLG_H_

#include "ExtListBox.h"

class CEsamiView;
class CSorgentiStreamingSet;

class CSorgentiStreamingConfigDlg : public CDialog
{

public:

	CSorgentiStreamingConfigDlg(CWnd* pParentWnd);
	virtual ~CSorgentiStreamingConfigDlg();

	enum { IDD = IDD_SORGENTISTREAMINGCONFIG };
...
private:
	...
	CEdit			m_ctrlEditIndirizzoStreaming;
	CEdit			m_ctrlEditNomeComputerSorgente;
