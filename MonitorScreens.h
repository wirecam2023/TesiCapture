...
#ifndef _MONITORSCREENS_H_
#define _MONITORSCREENS_H_
...
// CMonitorScreens command target

class CMonitorScreens : public CObject
{
public:
	CMonitorScreens();
	virtual ~CMonitorScreens();
