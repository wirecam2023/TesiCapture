...
IMPLEMENT_DYNAMIC(CMstDiagnosiModDlg, CDialog)

CMstDiagnosiModDlg::CMstDiagnosiModDlg(CWnd* pParent, CEsamiView* pEsamiView)
	: CDialog(CMstDiagnosiModDlg::IDD, pParent)
{
...
CMstDiagnosiModDlg::~CMstDiagnosiModDlg()
{
}

BEGIN_MESSAGE_MAP(CMstDiagnosiModDlg, CDialog)
	ON_WM_CTLCOLOR()
...
void CMstDiagnosiModDlg::DoDataExchange(CDataExchange* pDX)
{
...
HBRUSH CMstDiagnosiModDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
//			pDC->SetTextColor(theApp.m_color1);
			break;
...
BOOL CMstDiagnosiModDlg::OnInitDialog()
{
	...
	RiempiComboOrgano();
	theApp.LocalizeDialog(this, CMstDiagnosiModDlg::IDD, "MstDiagnosiModDlg");

	return bReturn;
}

void CMstDiagnosiModDlg::OnCbnSelchangeComboOrgano()
{
...
void CMstDiagnosiModDlg::OnLbnSelchangeListLevel0()
{
...
void CMstDiagnosiModDlg::OnLbnSelchangeListLevel1()
{
...
void CMstDiagnosiModDlg::OnLbnSelchangeListLevel2()
{
...
void CMstDiagnosiModDlg::OnLbnSelchangeListLevel3()
{
...
void CMstDiagnosiModDlg::OnLbnSelchangeListLevel4()
{
...
void CMstDiagnosiModDlg::OnLbnSelchangeListLevel5()
{
...
void CMstDiagnosiModDlg::OnLbnSelchangeListLevel6()
{
...
void CMstDiagnosiModDlg::OnBnClickedBtnNew0()
{
	NewString(0, 0);
}

void CMstDiagnosiModDlg::OnBnClickedBtnEdt0()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnDel0()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnNew1()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnEdt1()
{
	int iTemp = m_ctrlListLevel1.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnDel1()
{
	int iTemp = m_ctrlListLevel1.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnNew2()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnEdt2()
{
	int iTemp = m_ctrlListLevel2.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnDel2()
{
	int iTemp = m_ctrlListLevel2.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnNew3()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnEdt3()
{
	int iTemp = m_ctrlListLevel3.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnDel3()
{
	int iTemp = m_ctrlListLevel3.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnNew4()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnEdt4()
{
	int iTemp = m_ctrlListLevel4.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnDel4()
{
	int iTemp = m_ctrlListLevel4.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnNew5()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnEdt5()
{
	int iTemp = m_ctrlListLevel5.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnDel5()
{
	int iTemp = m_ctrlListLevel5.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnNew6()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnEdt6()
{
	int iTemp = m_ctrlListLevel6.GetCurSel();
...
void CMstDiagnosiModDlg::OnBnClickedBtnDel6()
{
	int iTemp = m_ctrlListLevel6.GetCurSel();
...
void CMstDiagnosiModDlg::RiempiComboOrgano()
{
	int iTemp = 0;
...
void CMstDiagnosiModDlg::RiempiListLevel0()
{
	int iTemp = 0;
	CString strTemp;
...
void CMstDiagnosiModDlg::RiempiListSubLevels(long lPadre)
{
...
void CMstDiagnosiModDlg::NewString(long lPadre, long lLivello)
{
...
void CMstDiagnosiModDlg::EdtString(long lContatore)
{
	CString strTemp;
	long lLivello = 0;
	BOOL bEdited = FALSE;
...
void CMstDiagnosiModDlg::DelString(long lContatore)
{
	CString strTemp;
	long lLivello = 0;
	BOOL bDeleted = FALSE;
