#ifndef _MSTDIAGNOSIMODDLG_H_
	#define _MSTDIAGNOSIMODDLG_H_

class CMstDiagnosiModDlg : public CDialog
{
	DECLARE_DYNAMIC(CMstDiagnosiModDlg)

public:

	CMstDiagnosiModDlg(CWnd* pParent, CEsamiView* pEsamiView);
	virtual ~CMstDiagnosiModDlg();

	enum { IDD = IDD_MST_DIAGNOSI_MOD };
