#ifndef _MSTPROCEDUREDIAGNOSTICHEMODDLG_H_
	#define _MSTPROCEDUREDIAGNOSTICHEMODDLG_H_

class CMstProcedureDiagnosticheModDlg : public CDialog
{
	DECLARE_DYNAMIC(CMstProcedureDiagnosticheModDlg)

public:

	CMstProcedureDiagnosticheModDlg(CWnd* pParent, CEsamiView* pEsamiView);
	virtual ~CMstProcedureDiagnosticheModDlg();

	enum { IDD = IDD_MST_PROCEDUREDIAGNOSTICHE_MOD };
...
#endif /* _MSTPROCEDUREDIAGNOSTICHEMODDLG_H_ */