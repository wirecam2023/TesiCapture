...
CNomenclatoreListaEsamiRepartoDlg::CNomenclatoreListaEsamiRepartoDlg(CWnd* pParentWnd, CEsamiView* pEsamiView, CString &sFiltroData, CString &sDataIniz, CString &sDataFine, CString &sSedeEsame, long lMedico, int nProvenienza)
...
BOOL CNomenclatoreListaEsamiRepartoDlg::OnInitDialog()
{
...
BOOL CNomenclatoreListaEsamiRepartoDlg::RiempiLista()
{
	BeginWaitCursor();
	...
	CString strView[2] = { "VistaEsamiInterni ", "VistaEsamiEsterni " };
