#ifndef _GRUPPIPRELIEVIMODDLG_H_
	#define _GRUPPIPRELIEVIMODDLG_H_

class CGruppiPrelieviModDlg : public CDialog
{
	DECLARE_DYNAMIC(CGruppiPrelieviModDlg)

public:

	CGruppiPrelieviModDlg(CWnd* pParent);
	virtual ~CGruppiPrelieviModDlg();
