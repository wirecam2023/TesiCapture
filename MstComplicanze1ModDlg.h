#ifndef _MSTCOMPLICANZE1MODDLG_H_
	#define _MSTCOMPLICANZE1MODDLG_H_

class CMstComplicanze1ModDlg : public CDialog
{
	DECLARE_DYNAMIC(CMstComplicanze1ModDlg)

public:

	CMstComplicanze1ModDlg(CWnd* pParent, CEsamiView* pEsamiView);
	virtual ~CMstComplicanze1ModDlg();

	enum { IDD = IDD_MST_COMPLICANZE1_MOD };
...
#endif /* _MSTCOMPLICANZE1MODDLG_H_ */