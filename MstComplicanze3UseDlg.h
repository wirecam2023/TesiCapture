#ifndef _MSTCOMPLICANZE3USEDLG_H_
	#define _MSTCOMPLICANZE3USEDLG_H_

#include "SediTreeCtrl.h"

class CMstComplicanze3UseDlg : public CDialog
{
	DECLARE_DYNAMIC(CMstComplicanze3UseDlg)

public:

	CMstComplicanze3UseDlg(CWnd* pParent, CEsamiView* pEsamiView);
	virtual ~CMstComplicanze3UseDlg();

	enum { IDD = IDD_MST_COMPLICANZE_USE };
...
#endif /* _MSTCOMPLICANZE3USEDLG_H_ */