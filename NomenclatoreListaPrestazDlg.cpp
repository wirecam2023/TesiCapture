...
CNomenclatoreListaPrestazDlg::CNomenclatoreListaPrestazDlg(CWnd* pParentWnd, CEsamiView* pEsamiView, CString &sFiltroData, CString &sDataIniz, CString &sDataFine, CString &sSedeEsame, long lMedico, int nProvenienza)
...
BOOL CNomenclatoreListaPrestazDlg::OnInitDialog()
{
...
UINT CNomenclatoreListaPrestazDlg::RiempiLista()
{
	BeginWaitCursor();
	...
	strQuery		+= "FROM VISTAPRESTAZIONI ";
	...
	if (setPrestazioni.IsOpen())
	{
		...
		setPrestazioni.CloseRecordset("CNomenclatoreListaPrestazDlg::RiempiLista");
	}
