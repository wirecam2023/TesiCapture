#ifndef _MSTPROCEDURETERAPEUTICHEMODDLG_H_
	#define _MSTPROCEDURETERAPEUTICHEMODDLG_H_

class CMstProcedureTerapeuticheModDlg : public CDialog
{
	DECLARE_DYNAMIC(CMstProcedureTerapeuticheModDlg)

public:

	CMstProcedureTerapeuticheModDlg(CWnd* pParent, CEsamiView* pEsamiView);
	virtual ~CMstProcedureTerapeuticheModDlg();

	enum { IDD = IDD_MST_PROCEDURETERAPEUTICHE_MOD };
...
#endif /* _MSTPROCEDURETERAPEUTICHEMODDLG_H_ */