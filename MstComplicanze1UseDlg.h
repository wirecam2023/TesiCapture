#ifndef _MSTCOMPLICANZE1USEDLG_H_
	#define _MSTCOMPLICANZE1USEDLG_H_

#include "SediTreeCtrl.h"

class CMstComplicanze1UseDlg : public CDialog
{
	DECLARE_DYNAMIC(CMstComplicanze1UseDlg)

public:

	CMstComplicanze1UseDlg(CWnd* pParent, CEsamiView* pEsamiView);
	virtual ~CMstComplicanze1UseDlg();
...
#endif /* _MSTCOMPLICANZE1USEDLG_H_ */