...
class CDiagnosiFinaliICD9FormEx : public CSubForm
{

public:

	CDiagnosiFinaliICD9FormEx(CWnd* pParent, CEsamiView* pEsamiView);
	~CDiagnosiFinaliICD9FormEx();
...
private:
	...
	STRUCT_DIAGNOSIFINALIICD9 m_ctrLine[MAX_OBJ_X_FORM];
