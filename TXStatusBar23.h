...
class CTXStatusBar23 : public CWnd
{

protected:

	DECLARE_DYNCREATE(CTXStatusBar23)
...
public:
	...
	CLSID const& GetClsid()
	{
		static CLSID const clsid
			= { 0x67D06A11, 0x8469, 0x11E5, { 0xA5, 0xC5, 0x0, 0x13, 0xD3, 0x50, 0x66, 0x7C } };
		return clsid;
	}
	...
	unsigned long get_DisplayColor(long index)
	{
		...
		InvokeHelper(0x17, DISPATCH_PROPERTYGET, VT_UI4, (void*)&result, parms, index);
		return result;
	}
	void put_DisplayColor(long index, unsigned long newValue)
	{
		static BYTE parms[] = VTS_I4 VTS_UI4 ;
		InvokeHelper(0x17, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, index, newValue);
	}
	void AboutBox()
	{
