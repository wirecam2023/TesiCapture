...
IMPLEMENT_DYNAMIC(CMstComplicanze1UseDlg, CDialog)

CMstComplicanze1UseDlg::CMstComplicanze1UseDlg(CWnd* pParent, CEsamiView* pEsamiView)
	: CDialog(CMstComplicanze1UseDlg::IDD, pParent)
{
...
CMstComplicanze1UseDlg::~CMstComplicanze1UseDlg()
{
}

BEGIN_MESSAGE_MAP(CMstComplicanze1UseDlg, CDialog)
	ON_WM_CTLCOLOR()
...
void CMstComplicanze1UseDlg::DoDataExchange(CDataExchange* pDX)
{
...
HBRUSH CMstComplicanze1UseDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
BOOL CMstComplicanze1UseDlg::OnInitDialog()
{
	...
	theApp.LocalizeDialog(this, CMstComplicanze1UseDlg::IDD, "MstComplicanze1UseDlg");
	
	SetWindowText(theApp.GetMessageString(IDS_FIELDDLG_ENDOX_FIELD_366));
...
CString CMstComplicanze1UseDlg::GetValue()
{
	return m_strValue;
}

void CMstComplicanze1UseDlg::SetValue(CString sValue)
{
	m_strValue = sValue;
}

void CMstComplicanze1UseDlg::OnBnClickedOk()
{
...
void CMstComplicanze1UseDlg::CreaFrase()
{
	int iTemp;
	CString strTemp;
	CString strValue = "";
...
void CMstComplicanze1UseDlg::RiempiListOrgani()
{
	int iTemp;
	...
	if (lTipoEsame == 0 || m_pEsamiView->m_pEsamiSet->IsFieldNull(&m_pEsamiView->m_pEsamiSet->m_lIDEsame))
	{
		...
		if (setTemp.OpenRecordset("CMstComplicanze1UseDlg::RiempiListOrgani") == TRUE)
		{
			while (!setTemp.IsEOF())
			{
			...
			setTemp.CloseRecordset("CMstComplicanze1UseDlg::RiempiListOrgani");
		}
	}
	else
	{
		...
		if (setJoin.OpenRecordset("CMstComplicanze1UseDlg::RiempiListOrgani") == TRUE)
		{
			while(setJoin.IsEOF() == FALSE)
			{
				...
				if (setOrgano.OpenRecordset("CMstComplicanze1UseDlg::RiempiListOrgani") == TRUE)
				{
			...
			setOrgano.CloseRecordset("CMstComplicanze1UseDlg::RiempiListOrgani");
			setJoin.CloseRecordset("CMstComplicanze1UseDlg::RiempiListOrgani");
		}
	}
}

void CMstComplicanze1UseDlg::RiempiTreeSedi()
{
	HTREEITEM hPadre;
	...
	if (setTemp1.OpenRecordset("CMstComplicanze1UseDlg::RiempiTreeSedi") == FALSE)
		return;
	...
	while(setTemp1.IsEOF() == FALSE)
	{
		...
		if (setTemp2.OpenRecordset("CMstComplicanze1UseDlg::RiempiTreeSedi") == TRUE)
		{
			...
			setTemp2.CloseRecordset("CMstComplicanze1UseDlg::RiempiTreeSedi");
		}
	...
	setTemp1.CloseRecordset("CMstComplicanze1UseDlg::RiempiTreeSedi");
}

void CMstComplicanze1UseDlg::RiempiListLevel0()
{
	int iTemp = 0;
...
void CMstComplicanze1UseDlg::RiempiListSubLevels()
{
...
void CMstComplicanze1UseDlg::OnBnClickedDeselect()
{
...
void CMstComplicanze1UseDlg::OnLbnSelchangeListOrgani()
{
	RiempiTreeSedi();
...
void CMstComplicanze1UseDlg::OnTvnSelchangedTreeSedi(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CMstComplicanze1UseDlg::OnLbnSelchangeListLevel0()
{
	RiempiListSubLevels();
...
void CMstComplicanze1UseDlg::OnLbnSelchangeListLevel1()
{
	CreaFrase();
}

void CMstComplicanze1UseDlg::OnLbnSelchangeListLevel2()
{
	CreaFrase();
}

void CMstComplicanze1UseDlg::OnLbnSelchangeListLevel3()
{
	CreaFrase();
}

void CMstComplicanze1UseDlg::OnLbnSelchangeListLevel4()
{
	CreaFrase();
}

void CMstComplicanze1UseDlg::OnLbnSelchangeListLevel5()
{
	CreaFrase();
}

void CMstComplicanze1UseDlg::OnLbnSelchangeListLevel6()
{
	CreaFrase();
}

void CMstComplicanze1UseDlg::OnBnClickedAggiungi()
{
	CString strFrase;
