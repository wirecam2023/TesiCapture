...
IMPLEMENT_DYNAMIC(CMstComplicanze3UseDlg, CDialog)

CMstComplicanze3UseDlg::CMstComplicanze3UseDlg(CWnd* pParent, CEsamiView* pEsamiView)
	: CDialog(CMstComplicanze3UseDlg::IDD, pParent)
{
...
CMstComplicanze3UseDlg::~CMstComplicanze3UseDlg()
{
}

BEGIN_MESSAGE_MAP(CMstComplicanze3UseDlg, CDialog)
	ON_WM_CTLCOLOR()
...
void CMstComplicanze3UseDlg::DoDataExchange(CDataExchange* pDX)
{
...
HBRUSH CMstComplicanze3UseDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
BOOL CMstComplicanze3UseDlg::OnInitDialog()
{
	...
	theApp.LocalizeDialog(this, CMstComplicanze3UseDlg::IDD, "MstComplicanze3UseDlg");
	
	SetWindowText(theApp.GetMessageString(IDS_FIELDDLG_ENDOX_FIELD_368));
...
CString CMstComplicanze3UseDlg::GetValue()
{
	return m_strValue;
}

void CMstComplicanze3UseDlg::SetValue(CString sValue)
{
	m_strValue = sValue;
}

void CMstComplicanze3UseDlg::OnBnClickedOk()
{
...
void CMstComplicanze3UseDlg::CreaFrase()
{
	int iTemp;
	CString strTemp;
	CString strValue = "";
...
void CMstComplicanze3UseDlg::RiempiListOrgani()
{
	int iTemp;
	...
	if (lTipoEsame == 0 || m_pEsamiView->m_pEsamiSet->IsFieldNull(&m_pEsamiView->m_pEsamiSet->m_lIDEsame))
	{
		...
		if (setTemp.OpenRecordset("CMstComplicanze3UseDlg::RiempiListOrgani") == TRUE)
		{
			while (!setTemp.IsEOF())
			{
			...
			setTemp.CloseRecordset("CMstComplicanze3UseDlg::RiempiListOrgani");
		}
	}
	else
	{
		...
		if (setJoin.OpenRecordset("CMstComplicanze3UseDlg::RiempiListOrgani") == TRUE)
		{
			while(setJoin.IsEOF() == FALSE)
			{
				...
				if (setOrgano.OpenRecordset("CMstComplicanze3UseDlg::RiempiListOrgani") == TRUE)
				{
			...
			setOrgano.CloseRecordset("CMstComplicanze3UseDlg::RiempiListOrgani");
			setJoin.CloseRecordset("CMstComplicanze3UseDlg::RiempiListOrgani");
		}
	}
}

void CMstComplicanze3UseDlg::RiempiTreeSedi()
{
	HTREEITEM hPadre;
	...
	if (setTemp1.OpenRecordset("CMstComplicanze3UseDlg::RiempiTreeSedi") == FALSE)
		return;
	...
	while(setTemp1.IsEOF() == FALSE)
	{
		...
		if (setTemp2.OpenRecordset("CMstComplicanze3UseDlg::RiempiTreeSedi") == TRUE)
		{
			...
			setTemp2.CloseRecordset("CMstComplicanze3UseDlg::RiempiTreeSedi");
		}
	...
	setTemp1.CloseRecordset("CMstComplicanze3UseDlg::RiempiTreeSedi");
}

void CMstComplicanze3UseDlg::RiempiListLevel0()
{
	int iTemp = 0;
...
void CMstComplicanze3UseDlg::RiempiListSubLevels()
{
...
void CMstComplicanze3UseDlg::OnBnClickedDeselect()
{
...
void CMstComplicanze3UseDlg::OnLbnSelchangeListOrgani()
{
	RiempiTreeSedi();
...
void CMstComplicanze3UseDlg::OnTvnSelchangedTreeSedi(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CMstComplicanze3UseDlg::OnLbnSelchangeListLevel0()
{
	RiempiListSubLevels();
...
void CMstComplicanze3UseDlg::OnLbnSelchangeListLevel1()
{
	CreaFrase();
}

void CMstComplicanze3UseDlg::OnLbnSelchangeListLevel2()
{
	CreaFrase();
}

void CMstComplicanze3UseDlg::OnLbnSelchangeListLevel3()
{
	CreaFrase();
}

void CMstComplicanze3UseDlg::OnLbnSelchangeListLevel4()
{
	CreaFrase();
}

void CMstComplicanze3UseDlg::OnLbnSelchangeListLevel5()
{
	CreaFrase();
}

void CMstComplicanze3UseDlg::OnLbnSelchangeListLevel6()
{
	CreaFrase();
}

void CMstComplicanze3UseDlg::OnBnClickedAggiungi()
{
	CString strFrase;
