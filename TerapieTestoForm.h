#ifndef _TERAPIETESTOFORM_H_
	#define _TERAPIETESTOFORM_H_

#include "SubForm.h"
#include "ExtFarmaci.h"
#include "ExtEdit.h"

class CTerapieTestoForm : public CSubForm
{

public:

	CTerapieTestoForm(CWnd* pParent, CEsamiView* pEsamiView);
	~CTerapieTestoForm();
