...
IMPLEMENT_DYNAMIC(CMstComplicanze1ModDlg, CDialog)

CMstComplicanze1ModDlg::CMstComplicanze1ModDlg(CWnd* pParent, CEsamiView* pEsamiView)
	: CDialog(CMstComplicanze1ModDlg::IDD, pParent)
{
...
CMstComplicanze1ModDlg::~CMstComplicanze1ModDlg()
{
}

BEGIN_MESSAGE_MAP(CMstComplicanze1ModDlg, CDialog)
	ON_WM_CTLCOLOR()
...
void CMstComplicanze1ModDlg::DoDataExchange(CDataExchange* pDX)
{
...
HBRUSH CMstComplicanze1ModDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
BOOL CMstComplicanze1ModDlg::OnInitDialog()
{
	...
	theApp.LocalizeDialog(this, CMstComplicanze1ModDlg::IDD, "MstComplicanze1ModDlg");
	return bReturn;
}

void CMstComplicanze1ModDlg::OnLbnSelchangeListLevel0()
{
...
void CMstComplicanze1ModDlg::OnLbnSelchangeListLevel1()
{
...
void CMstComplicanze1ModDlg::OnLbnSelchangeListLevel2()
{
...
void CMstComplicanze1ModDlg::OnLbnSelchangeListLevel3()
{
...
void CMstComplicanze1ModDlg::OnLbnSelchangeListLevel4()
{
...
void CMstComplicanze1ModDlg::OnLbnSelchangeListLevel5()
{
...
void CMstComplicanze1ModDlg::OnLbnSelchangeListLevel6()
{
...
void CMstComplicanze1ModDlg::OnBnClickedBtnNew0()
{
	NewString(0, 0);
}

void CMstComplicanze1ModDlg::OnBnClickedBtnEdt0()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnDel0()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnNew1()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnEdt1()
{
	int iTemp = m_ctrlListLevel1.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnDel1()
{
	int iTemp = m_ctrlListLevel1.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnNew2()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnEdt2()
{
	int iTemp = m_ctrlListLevel2.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnDel2()
{
	int iTemp = m_ctrlListLevel2.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnNew3()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnEdt3()
{
	int iTemp = m_ctrlListLevel3.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnDel3()
{
	int iTemp = m_ctrlListLevel3.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnNew4()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnEdt4()
{
	int iTemp = m_ctrlListLevel4.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnDel4()
{
	int iTemp = m_ctrlListLevel4.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnNew5()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnEdt5()
{
	int iTemp = m_ctrlListLevel5.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnDel5()
{
	int iTemp = m_ctrlListLevel5.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnNew6()
{
	int iTemp = m_ctrlListLevel0.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnEdt6()
{
	int iTemp = m_ctrlListLevel6.GetCurSel();
...
void CMstComplicanze1ModDlg::OnBnClickedBtnDel6()
{
	int iTemp = m_ctrlListLevel6.GetCurSel();
...
void CMstComplicanze1ModDlg::RiempiListLevel0()
{
	int iTemp = 0;
	CMstComplicanze1Set setTemp;
	...
	if (setTemp.OpenRecordset("CMstComplicanze1ModDlg::RiempiListLevel0") == TRUE)
	{
		...
		setTemp.CloseRecordset("CMstComplicanze1ModDlg::RiempiListLevel0");
	}
}

void CMstComplicanze1ModDlg::RiempiListSubLevels(long lPadre)
{
	...
	for(nTemp = 0; nTemp < 6; nTemp++)
	{
		...
		if (setTemp.OpenRecordset("CMstComplicanze1ModDlg::RiempiListSubLevels") == TRUE)
		{
			while(setTemp.IsEOF() == FALSE)
			{
	...
	setTemp.CloseRecordset("CMstComplicanze1ModDlg::RiempiListSubLevels");
}

void CMstComplicanze1ModDlg::NewString(long lPadre, long lLivello)
{
	...
	if (dlg.DoModal() == IDOK)
	{
		...
		if (setTemp.OpenRecordset("CMstComplicanze1ModDlg::NewString") == TRUE)
		{
			if (setTemp.AddNewRecordset("CMstComplicanze1ModDlg::NewString") == TRUE)
			{
				setTemp.m_lPadre = lPadre;
				setTemp.m_lLivello = lLivello;
				setTemp.m_sDescrizione = dlg.GetValue();

				setTemp.UpdateRecordset("CMstComplicanze1ModDlg::NewString");
			}

			setTemp.CloseRecordset("CMstComplicanze1ModDlg::NewString");
		}
...
void CMstComplicanze1ModDlg::EdtString(long lID)
{
	CString strTemp;
	long lLivello = 0;
	BOOL bEdited = FALSE;
	...
	if (setTemp.OpenRecordset("CMstComplicanze1ModDlg::EdtString") == TRUE)
	{
		if (setTemp.IsEOF() == FALSE)
		{
			...
			if (dlg.DoModal() == IDOK)
			{
				...
				if (setTemp.EditRecordset("CMstComplicanze1ModDlg::EdtString") == TRUE)
				{
					bEdited = TRUE;

					setTemp.m_sDescrizione = dlg.GetValue();

					setTemp.UpdateRecordset("CMstComplicanze1ModDlg::EdtString");
				}
			}
		}

		setTemp.CloseRecordset("CMstComplicanze1ModDlg::EdtString");
	}
...
void CMstComplicanze1ModDlg::DelString(long lID)
{
	CString strTemp;
	long lLivello = 0;
	BOOL bDeleted = FALSE;
	...
	if (setTemp.OpenRecordset("CMstComplicanze1ModDlg::EdtString") == TRUE)
	{
		...
		if (bDeleted == TRUE)
			setTemp.DeleteRecordset("CMstComplicanze1ModDlg::EdtString");
